def add_exp_arguments(parser, dataset_choices=None, model_choices=None, root_default=None, dataset_default=None, model_default=None, name_default=None, dataset_channel_choices=None, model_channel_choices=None, exp_channel_choices=None, dataset_channel_default=None, model_channel_default=None, exp_channel_default=None):
    ...
    parser.add_argument("-E", "--experiment_name", type=str, required=name_default is None, default=name_default, help="A directory name in experiment_root/dataset/model to save/access the model and logs.")
    parser.add_argument("-S", "--subfolder_name", type=str, default=None, help="Create subfolder in the experiment directory. Useful to separate runs with the same experiment config.")
